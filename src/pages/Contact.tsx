    ...
    <div>
      ...
      <div className="max-w-3xl">
        <div className="bg-[#1a1a1a] p-8 rounded-2xl border-t-4 border-[#E30613] relative overflow-hidden group">
          {/* Decorative element */}
          <div className="absolute -right-20 -top-20 w-64 h-64 bg-[#E30613]/5 rounded-full blur-3xl group-hover:bg-[#E30613]/10 transition duration-700 pointer-events-none" />
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start relative z-10">
            ...
            <div className="flex-1 text-center md:text-right">
              <h2 className="text-2xl font-bold mb-2">عمرو هشام</h2>
              <p className="text-gray-400 text-sm mb-6 leading-relaxed max-w-xl mx-auto md:mx-0">
                تقدر تتواصل معايا من خلال المنصات دي
              </p>
